      ...
      <div className="mx-auto max-w-5xl px-4 py-8 sm:py-12 lg:py-16">
        <Link to="/" className="flex justify-center items-center gap-2 mb-6">
          <img
            ...
            alt="Blog App Logo"
          />
          <p className="text-2xl font-semibold whitespace-nowrap text-gray-800">
            Blog App
          </p>
        </Link>

        <p className="mx-auto mt-4 max-w-md text-center text-sm sm:text-base leading-relaxed text-gray-500">
          Welcome to my blog, where curiosity meets creativity! I'm here to
          explore fascinating topics and share unique insights. Join the
          adventure—your thoughts make this community vibrant. Dive in and
        ...
        <nav className="mt-8">
          <ul className="flex flex-wrap justify-center gap-4 sm:gap-6 md:gap-8">
            ...
            <li>
              <Link to='/myblogs' className="text-gray-700 hover:text-gray-900 transition">
                My Blogs
              </Link>
            </li>
            <li>
        ...
        <ul className="mt-8 flex justify-center gap-6">
          <SocialIcon href="mailto:chukkalacharanteja9@gmail.com" icon="email" />
          <SocialIcon href="https://github.com/charanteja-7" icon="github" />
          <SocialIcon href="https://www.facebook.com/profile.php?id=100039763548475" icon="facebook" />
          <SocialIcon href="https://www.instagram.com/_charan_teja7/" icon="instagram" />
          <SocialIcon href="https://x.com/charan_teja7" icon="twitter" />
        </ul>
      </div>
    </footer>
  );
