            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  className="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:focus:ring-neutral-600"
                  rows="6"
                  placeholder="Provide the content of your blog"
                  required
                ></textarea>
              </div>
            </div>
